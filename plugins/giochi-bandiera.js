...
// BOTTONI COPIATI ESATTAMENTE DALLO STILE BANDIERA
const gameButtons = () => [{
    name: 'quick_reply',
...
let handler = async (m, { conn }) => {
    ...
    // INVIO UGUALE A BANDIERA
    await conn.sendMessage(chat, {
        image: img,
        caption: `🃏 *UNO MATCH*\n🎨 Colore attuale: *${unoSession[chat].currentColor}*\n\n_Invia il numero della carta o usa i bottoni_`,
        footer: '𝖇𝖑𝖔𝖔𝖉𝖇𝖔𝖙',
...
handler.before = async (m, { conn }) => {
    ...
    // LOGICA DI CATTURA BOTTONI COPIATA DA BANDIERA
